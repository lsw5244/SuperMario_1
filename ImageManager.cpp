...
{
	ImageManager::GetSingleton()->AddImage("Image/Character/SamllRedMario.bmp", 224, 64, 14, 2, true, RGB(255, 0, 255));
	ImageManager::GetSingleton()->AddImage("Image/Monster/Gunba.bmp", 64, 32, 4, 2, true, RGB(255, 0, 255));
	ImageManager::GetSingleton()->AddImage("Image/mario_overwordTile.bmp", 176, 208, 11, 13, true, RGB(255, 0, 255));
}
